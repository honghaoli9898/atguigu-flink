package com.sdps.flink.realtime.app;
	...
	public static void main(String[] args) throws Exception {
		...
		DebeziumSourceFunction<String> mysqlSource = MySQLSource
				...
				.deserializer(new DebeziumDeserializationSchema<String>() { // 自定义数
							private static final long serialVersionUID = 3930375795634217323L;
							...
							public void deserialize(SourceRecord sourceRecord,
								...
								Envelope.Operation operation = Envelope
										.operationFor(sourceRecord);
								// 获取值信息并转换为 Struct 类型
